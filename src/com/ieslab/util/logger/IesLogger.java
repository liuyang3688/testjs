package com.ieslab.util.logger;
...
public class IesLogger {
	...
	private static IesLogger s_logger = new IesLogger();
	static Map<String,IesLogger> m_instanceMap = new HashMap<String,IesLogger>();
	private String m_pathName = null;

	public static IesLogger instance() {
	...
	public static IesLogger instance(String name) {
		IesLogger log = null;
		if(!m_instanceMap.containsKey(name)){
		    log = new IesLogger(name);
