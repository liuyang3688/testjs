...
public class FengJiDao {
	 ...
	 * @return
	 */
	public List<JSONObject> getFengjiData(final String bjcsids, final String bjid, String starttime, String endtime) {
		...
		String sql = "select rowkey, "+bjcsids+" from ls_fengji where rowkey > '"+bjidStr+"-"+starttime+"' and rowkey <  '"+bjidStr+"-"+endtime+"' and (rowkey like '%-%000' or rowkey like '%-%500' ) order by rowkey ";
		try {
